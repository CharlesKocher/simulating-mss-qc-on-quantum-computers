...
#
# Modified from QISKit ACQUA. This version returns the intermediate values of the objective function and parameters during 
# the optimization for plotting the convergence (cplus, cminus, tplus, tminus)
"""
...
class VQE(QuantumAlgorithm):
    ...
    def _solve(self):
        opt_params, opt_val, cplus, cminus, tplus, tminus = self.find_minimum_eigenvalue()
        self._ret['eigvals'] = np.asarray([opt_val])
        self._ret['opt_params'] = opt_params
        self._ret['cplus'] = cplus
        self._ret['cminus'] = cminus
        self._ret['tplus'] = tplus
        self._ret['tminus'] = tminus
    ...
    def find_minimum_eigenvalue(self, initial_point=None):
        ...
        sol, opt, nfev, cplus, cminus, tplus, tminus = self._optimizer.optimize(self._var_form.num_parameters, self._energy_evaluation,
        ...
        return sol, opt, cplus, cminus, tplus, tminus
